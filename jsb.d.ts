...
declare namespace jsb
{
    ...
    export module fileUtils
    {
        ...
        *@return bool
        */
        export function writeToFile(valueMap: any, fullPath: strin): boolean;
        /**
        * write a Unit8Array into a file
        *
        *@param data Unit8Array
        *@param fullPath The full path to the file you want to save a string
        *@return bool
        */
        export function writeDataToFile(data: Uint8Array, fullPath: strin): boolean;
        /**
